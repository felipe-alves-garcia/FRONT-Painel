                ...
                <div className="row px-2 px-sm-0">
                    ...
                    <form onSubmit={(e) => {funEdit(e)}}>
                        ...
                        <div className="d-flex flex-md-row flex-column justify-content-center my-5 align-items-center">
                            <button type="submit" className="mx-md-5 mx-0 ho1 fs-5 mt-5 p-3 px-5 bg1 text-white fw-bold rounded-pill border border-0">
                                Atualizar
                                <i className="ms-3 bi bi-arrow-up-circle-fill"></i>
                            </button>
                            <button type="button" onClick={() => {funDel()}} className="mx-0 mx-md-5 ho1 fs-5 mt-4 mt-md-5 p-3 px-5 bg3 text-white fw-bold rounded-pill border border-0">
                                Deletar
